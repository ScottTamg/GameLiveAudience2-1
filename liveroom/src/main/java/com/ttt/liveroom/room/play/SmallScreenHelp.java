...
//        mVideoView = mWindowView.findViewById(R.id.ijk_video);
        ...
        mAvatarRoot = mWindowView.findViewById(R.id.avatar_rl);
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.iv_m_close) {
            ...
            mAvatarRoot.setVisibility(View.VISIBLE);
    ...
    public void addVideoView(ViewGroup viewGroup) {
        ...
        playerManager.setScaleType(PlayerActivityManager.SCALETYPE_FILLPARENT);
        playerManager.start();
