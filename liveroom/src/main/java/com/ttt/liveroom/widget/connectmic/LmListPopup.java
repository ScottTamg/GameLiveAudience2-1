...
public class LmListPopup extends PopupWindow implements View.OnTouchListener,
    ...
    private RelativeLayout mRlLmRoot;
    ...
    private int mLmMaxNum;
    public LmListPopup(Context context, List<ResponseMicBean.DataBean> list,
                       int lmMaxNum, LmListAdapter.LmClickListener listener) {
        this.mContext = context;
        this.mListener = listener;
        this.mList = list;
        this.mLmMaxNum = lmMaxNum;
        initViews();
    }
    ...
    private void initViews() {
        ...
        mRlLmRoot = (RelativeLayout) mRootView.findViewById(R.id.rl_lm_root);
        mRecyclerView = (RecyclerView) mRootView.findViewById(R.id.rv_lm);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(mContext));
        mAdapter = new LmListAdapter(mContext, mList, mLmMaxNum, mListener);
        ...
        mRlLmRoot.setOnClickListener(new View.OnClickListener() {
            @Override
