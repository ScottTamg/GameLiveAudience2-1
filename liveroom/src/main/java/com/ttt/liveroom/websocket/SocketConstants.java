...
//    public static final String APPLY_MIC_RESPONSE_RSP = "lm_agree_res";//观众收到主播连麦的响应
     ...
     * 音视频连麦用户列表
     */
    public static final String AUDIO_VIDEO_CALL_LIST_REQ = "audio_video_call_list_req";
    public static final String AUDIO_VIDEO_CALL_LIST_RES = "audio_video_call_list_res";

    /**
     * 静音
     */
    public static final String MUTE_REQ = "mute_req";
    public static final String MUTE_RES = "mute_res";
